 ...
 * @author Pamela
 */
public class ControladorObtenerDeterminante {
    private final PanelDeterminante laVista; 
    private final ModeloObtenerDeterminante elModelo; 
    
    public ControladorObtenerDeterminante(PanelDeterminante laVista, ModeloObtenerDeterminante elModelo){
               ...
               if(comprobarA12.isEmpty() && comprobarA13.isEmpty() && comprobarA14.isEmpty() && comprobarA15.isEmpty()){
                   ...
                   //Comprobemos cuantas filas tiene la matriz
                    ...
                    if(comprobarA21.isEmpty() && comprobarA31.isEmpty() && comprobarA41.isEmpty() && comprobarA51.isEmpty()){
                        ...
                        elModelo.obtenerDeterminante(matrizA);
